            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        {{ __('View/Edit ').$employee->first_name }}
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            <form action="{{ route('employees.update', [$company->id, $employee->id]) }}" method="post">
                                @csrf
                                @method('PUT')
                                ...
                                <button class="btn btn-primary btn-block mt-5" type="submit">{{ __('Update this Employee') }}</button>
                            </form>
